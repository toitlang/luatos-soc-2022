...
add_ldflags(" -Wl,--wrap=__adddf3 ", {force = true})
...
add_ldflags(" -Wl,--wrap=iprintf ", {force = true})
...
add_ldflags(" -Wl,--wrap=siprintf ", {force = true})
...
add_ldflags(" -Wl,--wrap=sniprintf ", {force = true})
...
add_ldflags(" -Wl,--wrap=vfiprintf ", {force = true})
