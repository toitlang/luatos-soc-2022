...
void *const g_plat_jt[PLAT_JT_COUNT] = {
    ...
    [PLAT_JT_Driver_USART0] = &Driver_USART0,
...
PLAT_STUB(Driver_USART0, 71)
PLAT_STUB(Driver_USART1, 72)
PLAT_STUB(GPIO_Config, 73)
PLAT_STUB(GPIO_ExtiConfig, 74)
PLAT_STUB(GPIO_ExtiSetCB, 75)
PLAT_STUB(GPIO_FastOutput, 76)
PLAT_STUB(GPIO_Input, 77)
PLAT_STUB(GPIO_InputMulti, 78)
PLAT_STUB(GPIO_IomuxEC618, 79)
PLAT_STUB(GPIO_OutPulse, 80)
PLAT_STUB(GPIO_Output, 81)
PLAT_STUB(GPIO_OutputMulti, 82)
PLAT_STUB(GPIO_PullConfig, 83)
PLAT_STUB(GPIO_ToPadEC618, 84)
PLAT_STUB(GPIO_Toggle, 85)
PLAT_STUB(GPIO_ToggleMulti, 86)
...
PLAT_STUB(I2C_Control, 149)
PLAT_STUB(I2C_GetCapabilities, 150)
PLAT_STUB(I2C_GetClockFreq, 151)
PLAT_STUB(I2C_GetDataCount, 152)
PLAT_STUB(I2C_GetStatus, 153)
PLAT_STUB(I2C_Initialize, 154)
PLAT_STUB(I2C_MasterReceive, 155)
PLAT_STUB(I2C_MasterTransmit, 156)
PLAT_STUB(I2C_PowerControl, 157)
PLAT_STUB(I2C_SlaveReceive, 158)
PLAT_STUB(I2C_Uninitialize, 159)
PLAT_STUB(OsaSystemTimeReadRamUtc, 160)
PLAT_STUB(OsaTimerSync, 161)
PLAT_STUB(PAD_driverInit, 162)
PLAT_STUB(PAD_enterLowPowerStatePrepare, 163)
PLAT_STUB(PAD_exitLowPowerStateRestore, 164)
PLAT_STUB(PAD_getDefaultConfig, 165)
PLAT_STUB(PAD_setPinConfig, 166)
PLAT_STUB(PAD_setPinPullConfig, 167)
PLAT_STUB(Pad0_WakeupIntHandler, 168)
PLAT_STUB(Pad1_WakeupIntHandler, 169)
PLAT_STUB(Pad2_WakeupIntHandler, 170)
PLAT_STUB(Pad3_WakeupIntHandler, 171)
PLAT_STUB(Pad4_WakeupIntHandler, 172)
PLAT_STUB(Pad5_WakeupIntHandler, 173)
PLAT_STUB(QSPI_CheckQEnFlag, 174)
PLAT_STUB(QSPI_PollingBusyFlagIntableOnce, 175)
PLAT_STUB(RTC_WakeupIntHandler, 176)
PLAT_STUB(ResetStateGet, 177)
PLAT_STUB(TIMER_clearInterruptFlags, 178)
PLAT_STUB(TIMER_deInit, 179)
PLAT_STUB(TIMER_driverInit, 180)
PLAT_STUB(TIMER_getDefaultConfig, 181)
PLAT_STUB(TIMER_getInterruptFlags, 182)
PLAT_STUB(TIMER_init, 183)
PLAT_STUB(TIMER_interruptConfig, 184)
PLAT_STUB(TIMER_start, 185)
PLAT_STUB(TIMER_stop, 186)
PLAT_STUB(UART_flush, 187)
PLAT_STUB(UART_init, 188)
PLAT_STUB(UART_receive, 189)
PLAT_STUB(UART_send, 190)
PLAT_STUB(UART_setBaudrate, 191)
PLAT_STUB(USART0_IRQHandler, 192)
PLAT_STUB(USART1_DmaRxEvent, 193)
PLAT_STUB(USART1_DmaTxEvent, 194)
PLAT_STUB(USART1_IRQHandler, 195)
PLAT_STUB(USART2_DmaRxEvent, 196)
PLAT_STUB(USART2_IRQHandler, 197)
PLAT_STUB(USART_Control, 198)
PLAT_STUB(USART_DmaRxEvent, 199)
PLAT_STUB(USART_DmaTxEvent, 200)
PLAT_STUB(USART_GetBaudRate, 201)
PLAT_STUB(USART_GetCapabilities, 202)
PLAT_STUB(USART_GetModemStatus, 203)
PLAT_STUB(USART_GetRxCount, 204)
PLAT_STUB(USART_GetStatus, 205)
PLAT_STUB(USART_GetTxCount, 206)
PLAT_STUB(USART_IRQHandler, 207)
PLAT_STUB(USART_Initialize, 208)
PLAT_STUB(USART_PowerControl, 209)
PLAT_STUB(USART_Receive, 210)
PLAT_STUB(USART_Send, 211)
PLAT_STUB(USART_SendPolling, 212)
PLAT_STUB(USART_SetBaudrate, 213)
PLAT_STUB(USART_SetModemControl, 214)
PLAT_STUB(USART_Uninitialize, 215)
PLAT_STUB(Uart_BaseInitEx, 216)
PLAT_STUB(Uart_ChangeBR, 217)
PLAT_STUB(Uart_DeInit, 218)
PLAT_STUB(Uart_IsTSREmpty, 219)
PLAT_STUB(Uart_RxBufferClear, 220)
PLAT_STUB(Uart_RxBufferRead, 221)
PLAT_STUB(Uart_TxTaskSafe, 222)
PLAT_STUB(WDT_deInit, 223)
PLAT_STUB(WDT_getStartStatus, 224)
PLAT_STUB(WDT_init, 225)
PLAT_STUB(WDT_kick, 226)
PLAT_STUB(WDT_start, 227)
PLAT_STUB(WDT_stop, 228)
PLAT_STUB(WDT_unlock, 229)
PLAT_STUB(XIC_EnableIRQ, 230)
PLAT_STUB(XIC_SetVector, 231)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 232)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 233)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 234)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 235)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 236)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 237)
PLAT_STUB(_ZdaPv, 238)
PLAT_STUB(_ZdlPv, 239)
PLAT_STUB(__aeabi_atexit, 240)
PLAT_STUB(__aeabi_cdcmpeq, 241)
PLAT_STUB(__aeabi_cdcmple, 242)
PLAT_STUB(__aeabi_cdrcmple, 243)
PLAT_STUB(__aeabi_d2f, 244)
PLAT_STUB(__aeabi_d2iz, 245)
PLAT_STUB(__aeabi_d2lz, 246)
PLAT_STUB(__aeabi_d2uiz, 247)
PLAT_STUB(__aeabi_d2ulz, 248)
PLAT_STUB(__aeabi_dadd, 249)
PLAT_STUB(__aeabi_dcmpeq, 250)
PLAT_STUB(__aeabi_dcmpge, 251)
PLAT_STUB(__aeabi_dcmpgt, 252)
PLAT_STUB(__aeabi_dcmple, 253)
PLAT_STUB(__aeabi_dcmplt, 254)
PLAT_STUB(__aeabi_dcmpun, 255)
PLAT_STUB(__aeabi_ddiv, 256)
PLAT_STUB(__aeabi_dmul, 257)
PLAT_STUB(__aeabi_drsub, 258)
PLAT_STUB(__aeabi_dsub, 259)
PLAT_STUB(__aeabi_f2d, 260)
PLAT_STUB(__aeabi_i2d, 261)
PLAT_STUB(__aeabi_l2d, 262)
PLAT_STUB(__aeabi_ldivmod, 263)
PLAT_STUB(__aeabi_ui2d, 264)
PLAT_STUB(__aeabi_ul2d, 265)
PLAT_STUB(__aeabi_uldivmod, 266)
PLAT_STUB(__assert_func, 267)
PLAT_STUB(__cxa_thread_atexit, 268)
PLAT_STUB(__emutls_get_address, 269)
PLAT_STUB(__popcountdi2, 270)
PLAT_STUB(__popcountsi2, 271)
PLAT_STUB(__wrap_time, 272)
PLAT_STUB(abort, 273)
PLAT_STUB(acos, 274)
PLAT_STUB(aligned_alloc, 275)
PLAT_STUB(apmuSetDeepestSleepMode, 276)
PLAT_STUB(appGetECBCInfoSync, 277)
PLAT_STUB(appSetCFUN, 278)
PLAT_STUB(asin, 279)
PLAT_STUB(atan, 280)
PLAT_STUB(atan2, 281)
PLAT_STUB(calloc, 282)
PLAT_STUB(ceil, 283)
PLAT_STUB(cos, 284)
PLAT_STUB(cosh, 285)
PLAT_STUB(delay_us, 286)
PLAT_STUB(deregisterPSEventCallback, 287)
PLAT_STUB(exp, 288)
PLAT_STUB(fabs, 289)
PLAT_STUB(fclose, 290)
PLAT_STUB(feof, 291)
PLAT_STUB(fflush, 292)
PLAT_STUB(floor, 293)
PLAT_STUB(fmod, 294)
PLAT_STUB(fopen, 295)
PLAT_STUB(fotaNvmNfsPeInit, 296)
PLAT_STUB(fputc, 297)
PLAT_STUB(fputs, 298)
PLAT_STUB(fread, 299)
PLAT_STUB(free, 300)
PLAT_STUB(fseek, 301)
PLAT_STUB(fwrite, 302)
PLAT_STUB(gmtime_r, 303)
PLAT_STUB(isspace, 304)
PLAT_STUB(localtime_r, 305)
PLAT_STUB(log, 306)
PLAT_STUB(luat_mobile_config, 307)
PLAT_STUB(luat_rtos_task_create, 308)
PLAT_STUB(luat_rtos_task_sleep, 309)
PLAT_STUB(luat_uart_exist, 310)
PLAT_STUB(luat_uart_write, 311)
PLAT_STUB(malloc, 312)
PLAT_STUB(memchr, 313)
PLAT_STUB(memcmp, 314)
PLAT_STUB(memcpy, 315)
PLAT_STUB(memmove, 316)
PLAT_STUB(memset, 317)
PLAT_STUB(mktime, 318)
PLAT_STUB(osDelay, 319)
PLAT_STUB(osKernelGetTickCount, 320)
PLAT_STUB(pbuf_alloc, 321)
PLAT_STUB(pbuf_cat, 322)
PLAT_STUB(pbuf_free, 323)
PLAT_STUB(pbuf_ref, 324)
PLAT_STUB(pow, 325)
PLAT_STUB(printf, 326)
PLAT_STUB(psSetCdgcont, 327)
PLAT_STUB(putchar, 328)
PLAT_STUB(putenv, 329)
PLAT_STUB(puts, 330)
PLAT_STUB(pwrKeyIntHandler, 331)
PLAT_STUB(rand, 332)
PLAT_STUB(realloc, 333)
PLAT_STUB(registerPSEventCallback, 334)
PLAT_STUB(rngGenRandom, 335)
PLAT_STUB(round, 336)
PLAT_STUB(sin, 337)
PLAT_STUB(sinh, 338)
PLAT_STUB(slot_marker_read, 339)
PLAT_STUB(slot_marker_write, 340)
PLAT_STUB(slpManAonWdtFeed, 341)
PLAT_STUB(slpManAonWdtStop, 342)
PLAT_STUB(slpManApplyPlatVoteHandle, 343)
PLAT_STUB(slpManDeepSlpTimerDel, 344)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 345)
PLAT_STUB(slpManDeepSlpTimerStart, 346)
PLAT_STUB(slpManDrvVoteSleep, 347)
PLAT_STUB(slpManExcutePredefinedBackupCb, 348)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 349)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 350)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 351)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 352)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 353)
PLAT_STUB(slpManExtIntPreProcess, 354)
PLAT_STUB(slpManGetDrvBitmap, 355)
PLAT_STUB(slpManGetDrvVoteMask, 356)
PLAT_STUB(slpManGetLastSlpState, 357)
PLAT_STUB(slpManGetWakeupPadCfg, 358)
PLAT_STUB(slpManGetWakeupPinValue, 359)
PLAT_STUB(slpManGivebackPlatVoteHandle, 360)
PLAT_STUB(slpManPlatGetSlpState, 361)
PLAT_STUB(slpManPlatVoteDisableSleep, 362)
PLAT_STUB(slpManPlatVoteEnableSleep, 363)
PLAT_STUB(slpManProductionTest, 364)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 365)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 366)
PLAT_STUB(slpManSetDrvVoteMask, 367)
PLAT_STUB(slpManSetPmuSleepMode, 368)
PLAT_STUB(slpManSetWakeupPadCfg, 369)
PLAT_STUB(slpManStartPowerOff, 370)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 371)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 372)
PLAT_STUB(slpManUpdatePmuTimingCfg, 373)
PLAT_STUB(snprintf, 374)
PLAT_STUB(soc_call_function_in_service, 375)
PLAT_STUB(soc_cms_proc, 376)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 377)
PLAT_STUB(soc_free_later, 378)
PLAT_STUB(soc_get_poweron_time_ms, 379)
PLAT_STUB(soc_get_poweron_time_tick, 380)
PLAT_STUB(soc_info, 381)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 382)
PLAT_STUB(soc_mobile_search_cell_info_async, 383)
PLAT_STUB(soc_mobile_set_rrc_release_time, 384)
PLAT_STUB(soc_netif_input_prepare, 385)
PLAT_STUB(soc_power_mode, 386)
PLAT_STUB(soc_printf, 387)
PLAT_STUB(soc_set_usb_sleep, 388)
PLAT_STUB(soc_uart0_set_log_off, 389)
PLAT_STUB(soc_unilog_callback, 390)
PLAT_STUB(soc_usb_onoff, 391)
PLAT_STUB(soc_usb_serial_output, 392)
PLAT_STUB(soc_vsprintf, 393)
PLAT_STUB(sprintf, 394)
PLAT_STUB(sqrt, 395)
PLAT_STUB(srand, 396)
PLAT_STUB(sscanf, 397)
PLAT_STUB(strcat, 398)
PLAT_STUB(strchr, 399)
PLAT_STUB(strcmp, 400)
PLAT_STUB(strcpy, 401)
PLAT_STUB(strcspn, 402)
PLAT_STUB(strdup, 403)
PLAT_STUB(strerror, 404)
PLAT_STUB(strlen, 405)
PLAT_STUB(strncat, 406)
PLAT_STUB(strncmp, 407)
PLAT_STUB(strncpy, 408)
PLAT_STUB(strnlen, 409)
PLAT_STUB(strspn, 410)
PLAT_STUB(strstr, 411)
PLAT_STUB(strtod, 412)
PLAT_STUB(strtoul, 413)
PLAT_STUB(tan, 414)
PLAT_STUB(tanh, 415)
PLAT_STUB(tcp_accept, 416)
PLAT_STUB(tcp_arg, 417)
PLAT_STUB(tcp_bind, 418)
PLAT_STUB(tcp_close, 419)
PLAT_STUB(tcp_connect, 420)
PLAT_STUB(tcp_err, 421)
PLAT_STUB(tcp_listen_with_backlog, 422)
PLAT_STUB(tcp_new, 423)
PLAT_STUB(tcp_output, 424)
PLAT_STUB(tcp_recv, 425)
PLAT_STUB(tcp_recved, 426)
PLAT_STUB(tcp_sent, 427)
PLAT_STUB(tcp_shutdown, 428)
PLAT_STUB(tcp_write, 429)
PLAT_STUB(tcpip_callback_with_block, 430)
PLAT_STUB(trimAdcSetGolbalVar, 431)
PLAT_STUB(trunc, 432)
PLAT_STUB(tzset, 433)
PLAT_STUB(udp_bind, 434)
PLAT_STUB(udp_connect, 435)
PLAT_STUB(udp_new, 436)
PLAT_STUB(udp_recv, 437)
PLAT_STUB(udp_remove, 438)
PLAT_STUB(udp_send, 439)
PLAT_STUB(udp_sendto, 440)
PLAT_STUB(vPortGetHeapStats, 441)
PLAT_STUB(vPortGetHeapTag, 442)
PLAT_STUB(vPortIterateAllocations, 443)
PLAT_STUB(vPortSetHeapTag, 444)
PLAT_STUB(vQueueDelete, 445)
PLAT_STUB(vTaskDelete, 446)
PLAT_STUB(vfprintf, 447)
PLAT_STUB(vsnprintf, 448)
PLAT_STUB(xQueueCreateMutex, 449)
PLAT_STUB(xQueueGenericCreate, 450)
PLAT_STUB(xQueueGenericReceive, 451)
PLAT_STUB(xQueueGenericSend, 452)
PLAT_STUB(xQueueGenericSendFromISR, 453)
PLAT_STUB(xQueueGetMutexHolder, 454)
PLAT_STUB(xTaskCreate, 455)
PLAT_STUB(xTaskGenericNotify, 456)
PLAT_STUB(xTaskGetCurrentTaskHandle, 457)
PLAT_STUB(xTaskNotifyWait, 458)
